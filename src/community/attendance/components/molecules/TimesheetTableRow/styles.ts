...
export const timesheetTableRowStyles = (theme: Theme, selectedTab: string) => ({
  rowContainer: {
    width:
  ...
  cell: (isHoliday: boolean) => ({
    ...
    minWidth: "6.5rem",
    maxWidth:
      selectedTab === TimesheetAnalyticsTabTypes.WEEK ? "auto" : "6.9rem",
    [theme.breakpoints.down("xl")]: {
      maxWidth: "6.9rem"
    },
    [theme.breakpoints.down("lg")]: {
    ...
    bgcolor: isHoliday ? theme.palette.grey[100] : "transparent",
    height: "4.3rem",
