...
const superAdminRoutes = {
  [ROLE_SUPER_ADMIN]: [
    ...
    ROUTES.SIGN.SENT,
    ROUTES.SIGN.ALL_DONE,
    ROUTES.SIGN.COMPLETE_DOCUMENT,
    ROUTES.SIGN.DECLINED_DOCUMENT,
    ROUTES.SIGN.DOCUMENT_NOT_FOUND,
    ROUTES.SIGN.EXPIRED_LINK,
    ROUTES.SIGN.SESSION_EXPIRED,
    ROUTES.SIGN.UPDATED_LINK,
